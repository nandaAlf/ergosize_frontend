...
// const LOCAL_STUDIES: Record<string, any> = {
//   germany: germanyISO,
//   // cuba: cubaData,
//   // ... otros estudios
// };
...
//     // Determinar si es un estudio local (por nombre) o de API (por ID numérico)
...
//   // Obtener los datos del estudio local si aplica
...
//           end_date={"1/1/2000"}
//           classification={"AD"}
//           // Opcional: puedes pasar gender y dimensions incluso para datos locales
//           gender={"mixto"}
//           dimensions={[]}
//         />
//       )}
...
const Tables = () => {
  const { id: studyIdOrName } = useParams<{ id: string }>();
  const location = useLocation();
  const state = location.state as { study?: ApiStudy; filters?: Filters } || {};
  ...
  const currentStudy = apiStudy || (localStudy ? {
    ...localStudy.metadata,
